      ...
      <footer id="colophon" className="site-footer">
        ...
        {(_.get(this.props, 'pageContext.site.siteMetadata.footer.nav_links', null) && _.get(this.props, 'pageContext.site.siteMetadata.footer.has_nav', null)) && (
          ...
          <div className="secondary-nav container">
            <div className='row'>
              {_.map(_.get(this.props, 'pageContext.site.siteMetadata.footer.nav_links', null), (navgroup, navgroup_idx) => (
                <div className="  col-sm-6 col-md-3">
                  <ul>
                    <h5>{_.get(navgroup, 'groupHeading', null)}</h5>
                    {_.map(_.get(navgroup, 'links', null), (action, action_idx) => (
                      <li key={action_idx}>
                        <a href={_.get(action, 'url', null)}>{_.get(action, 'label', null)}</a>
